...
curl -v http://127.0.0.1:8091/pools/default -d memoryQuota=1024 -d indexMemoryQuota=512
...
curl -i -u $CLUSTER_CUSTOM_USERNAME:$CLUSTER_CUSTOM_PASSWORD -X POST http://127.0.0.1:8091/settings/indexes -d 'storageMode=forestdb'
